...
?>
		...
		<div class="verynsbigboxcontainer">
			...
			<h2><?php echo $ns_full_name; ?> <?php _e('Settings', $ns_ccp_text_domain) ?></h2>
			<p>&nbsp;</p>
			<form method="post" action="options.php" enctype="multipart/form-data">
	    		<?php /* *** BOX OPTION *** */ ?>
				<?php require_once( plugin_dir_path(__FILE__).'/ns_settings_custom.php'); ?>				
				<p><input type="submit" class="button-primary" id="submit" name="submit" value="<?php _e('Save Changes', $ns_ccp_text_domain) ?>" /></p>				
			</form>
		</div>
